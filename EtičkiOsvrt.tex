...
\begin{subfigure}{.5\textwidth}
  ...
  \begin{tikzpicture} [scale=0.6, every node/.style={scale=0.6}]
    ...
    \end{tikzpicture}
    \caption{Paket sadrži astaxanthin}
...
\begin{subfigure}{.5\textwidth}
  \centering
    ...
    \end{tikzpicture}
    \caption{Paket ne sadrži astaxanthin}
    \label{fig:wout_astaxanthin}
\end{subfigure}
\caption{Prosečni udeo cene suplementa u paketu koji sadrži po jedan suplement iz svake kategorije}
\label{fig:suplementi_udeo}
\end{figure}